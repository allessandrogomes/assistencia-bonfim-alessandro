...
<body>
    ...
    <main>
        <div class="titulo-principal__texto--icone">
            ...
            <h1 class="titulo-principal__pastas">Defeitos</h1>
        </div>
        <section class="container-principal__pastas">
            <div class="container__pastas">
                    <ul class="ul__pastas treinamentos">
                        <li class="itens-lista__pastas treinamentos"><a class="link-itens-lista__pastas" href="./procedentes.php">
                            <div class="container__imagem-pasta--texto">
                                <img class="icone__pasta" src="./img/icone-pasta.png" alt="">
                                <h2 class="titulo__pasta">Procedentes</h2>
                            </div>
                        </a></li>
                        <li class="itens-lista__pastas treinamentos"><a class="link-itens-lista__pastas" href="./defeitos-improcedentes.php">
                            <div class="container__imagem-pasta--texto">
                                <img class="icone__pasta" src="./img/icone-pasta.png" alt="">
                                <h2 class="titulo__pasta">Improcedentes</h2>
                            </div>
                        </a></li>
                    </ul>
            </div>
