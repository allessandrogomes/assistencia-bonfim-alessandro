...
<body>
    ...
    <main>
        <div class="titulo-principal__texto--icone">
            ...
            <h1 class="titulo-principal__pastas">Defeitos improcedentes</h1>
        </div>
        <section class="container-principal__pastas">
            <div class="container__pastas">
                    <ul class="ul__pastas">
                        <li class="itens-lista__pastas"><a class="link-itens-lista__pastas" href="./sobrecarga-imp.php">
                        ...
                        <li class="itens-lista__pastas"><a class="link-itens-lista__pastas" href="./polo-danificado.php">
                            <div class="container__imagem-pasta--texto">
                                <img class="icone__pasta" src="./img/icone-pasta.png" alt="">
                                <h2 class="titulo__pasta">Polo danificado</h2>
                            </div>
                        </a></li>
                        <li class="itens-lista__pastas"><a class="link-itens-lista__pastas" href="./caixa-danificada.php">
                            <div class="container__imagem-pasta--texto">
                                <img class="icone__pasta" src="./img/icone-pasta.png" alt="">
                                <h2 class="titulo__pasta">Caixa danificada</h2>
                            </div>
                        </a></li>
                        <li class="itens-lista__pastas"><a class="link-itens-lista__pastas" href="./visor-violado.php">
                            <div class="container__imagem-pasta--texto">
                                <img class="icone__pasta" src="./img/icone-pasta.png" alt="">
                                <h2 class="titulo__pasta">Visor violado</h2>
                            </div>
                        </a></li>
                        <li class="itens-lista__pastas"><a class="link-itens-lista__pastas" href="./polaridade-invertida.php">
                            <div class="container__imagem-pasta--texto">
                                <img class="icone__pasta" src="./img/icone-pasta.png" alt="">
                                <h2 class="titulo__pasta">Polaridade invertida</h2>
                            </div>
                        </a></li>
